...
public class GroundAdapter extends RecyclerView.Adapter<GroundAdapter.MyViewHolder> implements Filterable  {

    List<Grounds> list=new ArrayList();
    List<Grounds> listmain=new ArrayList();
    Context context;
    public GroundAdapter(Context c, List<Grounds> list)
    {
        this.list=list;
        listmain=list;
        this.context=c;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v= LayoutInflater.from(context).inflate(R.layout.view_grounds,null);
        return new MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
//        myViewHolder.game.setText(list.get(i).gets());
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                final List<Grounds> list = listmain;

                int count = list.size();
                final ArrayList<Grounds> nlist = new ArrayList<Grounds>(count);
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                list = (ArrayList<Grounds>) filterResults.values;

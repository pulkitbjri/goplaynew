...
public class TournmemtAdapterFull extends RecyclerView.Adapter<TournmemtAdapterFull.MyViewHolder> implements Filterable {
    List<Tournaments> listmain=new ArrayList();

    List<Tournaments> list=new ArrayList();
    Context context;
    public TournmemtAdapterFull(Context c, List<Tournaments> list)
    {
        this.list=list;
        this.context=c;
        listmain=list;
